...
<div id="wrap">
 ...
 <form action="./MemberUpdate.me" method="get" enctype="application/x-www-form-urlencoded">
   ...
   <div class="user-profile">
	...
	<div>
     ...
     <div class="user-passwd">
	  ...
	  <div> <input type="text" name="passwd" value="${passwd }" class="inputstyleid" readonly="readonly"> </div>
	 </div>
	 
	 <div class="user-name">
	  <div class="user-font"> 이름 </div>
	  <div> <input type="text" name="name" value="${name }" class="inputstyleid" readonly="readonly"> </div>
	 </div>
	 
	 <div class="user-nicname">
	  <div class="user-font"> 닉네임 </div>
	  <div> <input type="text" name="nicname" value="${nicname }" class="inputstyleid" readonly="readonly"> </div>
	 </div>
	 
	 <div class="user-email">
	  <div class="user-font"> 이메일 </div>
	  <div> <input type="email" name="email" value="${email }" class="inputstyleid" readonly="readonly"> </div>
	 </div>
	 ...
	 <div class="user-membertech">
	  ...
	  <div> 
	  <input type="text" name="membertech" value="${membertech }" class="inputstyleid" readonly="readonly">
	  </div>
	 </div>
	</div>
	<br><br>
	...
	<c:choose>
	 <c:when test="${sessionScope.seman eq 1}">
	  <button name="updatebtn" type="button" onclick="location.href='./MemberUpdateView.me?id=${param.id}'" class="user-info-update">회원 수정</button>
	 </c:when>
	 <c:otherwise>
	  <button name="updatebtn" type="button" onclick="location.href='./MemberUpdateView.me?id=${param.id}'" class="user-info-update">정보 수정</button>
	 </c:otherwise>
	</c:choose>
	<c:choose>
	 <c:when test="${sessionScope.seman eq 1}">
	  <button name="deletebtn" type="button" onclick="location.href='./MemberDeleteView.me?id=${param.id}'" class="user-info-delete">회원 삭제</button>
	 </c:when>
	 <c:otherwise>
	  <button name="deletebtn" type="button" onclick="location.href='./MemberDeleteView.me?id=${param.id}'" class="user-info-delete">회원 탈퇴</button>
	 </c:otherwise>
	</c:choose>
