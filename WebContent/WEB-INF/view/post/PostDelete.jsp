...
<div id="wrap">
 ...
 <form name="join" action="./PostDelete.po" method="post" enctype="application/x-www-form-urlencoded">
 <div class="postDelete-page">
  <fieldset style="width: 400px">
  <div><p><font> 게시글 삭제 </font></p></div><hr><br><br>
   <font class="fontsmall">게시글을 삭제하시겠습니까?</font><br><br>
   <p>
    <input type="hidden" name="postnum" value="${param.postnum}" class="inputstylenum" >
   </p>
  
  <br><br>
  <p>
   <button type="button" class="deletepost_btn" onclick="Deletepost()">삭제</button>
   <button type="button"  class="deletepost_btn" onclick="location.href='./PostSelectDetail.po?postnum=${param.postnum}'">취소</button>
  </p> 
  </fieldset>
  </div>
 </form>
